    ...
    styles: {
      ...
      paragraphStyles: [
        { id: 'Heading1', name: 'Heading 1', basedOn: 'Normal', next: 'Normal', quickFormat: true,
          ...
          paragraph: { spacing: { before: 240, after: 120 }, outlineLevel: 0, bidirectional: true } },
        { id: 'Heading2', name: 'Heading 2', basedOn: 'Normal', next: 'Normal', quickFormat: true,
          run: { size: 32, bold: true, font: fontFamily, color: page.color?.replace('#', '') || '333333' },
          paragraph: { spacing: { before: 200, after: 100 }, outlineLevel: 1, bidirectional: true } },
        { id: 'Heading3', name: 'Heading 3', basedOn: 'Normal', next: 'Normal', quickFormat: true,
          run: { size: 28, bold: true, font: fontFamily },
          paragraph: { spacing: { before: 160, after: 80 }, outlineLevel: 2, bidirectional: true } },
        { id: 'Heading4', name: 'Heading 4', basedOn: 'Normal', next: 'Normal', quickFormat: true,
          run: { size: 24, bold: true, font: fontFamily },
          paragraph: { spacing: { before: 120, after: 60 }, outlineLevel: 3, bidirectional: true } },
      ],
    },
    numbering: {
      config: [
